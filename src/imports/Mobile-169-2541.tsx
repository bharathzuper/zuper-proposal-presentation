import svgPaths from "./svg-uuee335zrk";
...
function Battery() {
  return (
    <div className="-translate-y-1/2 absolute h-[11.333px] right-[14.34px] top-[calc(50%+1px)] w-[24.328px]" data-name="Battery">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24.328 11.3333">
        <g id="Battery">
          <rect height="10.3333" id="Border" opacity="0.35" rx="2.16667" stroke="var(--stroke-0, #252A31)" width="21" x="0.5" y="0.5" />
          <path d={svgPaths.p9ed9280} fill="var(--fill-0, #252A31)" id="Cap" opacity="0.4" />
          <rect fill="var(--fill-0, #252A31)" height="7.33333" id="Capacity" rx="1.33333" width="18" x="2" y="2" />
        </g>
      </svg>
    </div>
  );
...
function StatusBar() {
  return (
    <div className="h-[44px] relative shrink-0 w-[390px]" data-name="Status Bar">
...
function TitleBar() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[390px]" data-name="Title Bar">
      <Wrapper />
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Path" />
          <circle cx="10" cy="10" id="Oval" r="7" stroke="var(--stroke-0, #252A31)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M21 21L15 15" id="Path_2" stroke="var(--stroke-0, #252A31)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function InputFieldWithoutLabel() {
  return (
    <div className="bg-[#eff2f5] relative rounded-[6px] shrink-0 w-full" data-name="InputField without label">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[10px] relative w-full">
          <Icon />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#697d95] text-[14px] tracking-[0.2px]">Search a product or a service</p>
        </div>
      </div>
    </div>
  );
...
function Frame56() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col items-start pb-[8px] pt-[4px] px-[16px] relative w-full">
...
function Tab6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center justify-end overflow-clip px-[16px] py-[12px] relative shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#252a31] text-[14px] text-center">Products</p>
      <div className="-translate-x-1/2 absolute bottom-[-2px] h-0 left-[calc(50%+0.5px)] w-[56px]">
        <div className="absolute inset-[-4px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 56 4">
            <line id="Line 1" stroke="var(--stroke-0, #E44A19)" strokeLinecap="round" strokeWidth="4" x1="2" x2="54" y1="2" y2="2" />
          </svg>
...
function Tab7() {
  return (
    <div className="content-stretch flex flex-col items-center justify-end px-[16px] py-[12px] relative shrink-0" data-name="Tab">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#4f5e71] text-[14px] text-center">Selected (2)</p>
    </div>
  );
}
...
function Subtask() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="subtask">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Path" />
          <path d="M6 9H12" id="Path_2" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M4 5H8" id="Path_3" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d={svgPaths.p21130200} id="Path_4" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <rect height="4" id="Rectangle" rx="1" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" width="8" x="12" y="7" />
          <rect height="4" id="Rectangle_2" rx="1" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" width="8" x="12" y="15" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="flex-[1_0_0] min-h-px min-w-px relative self-stretch">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[12px] items-center justify-center px-[16px] py-[12px] relative size-full">
          <Subtask />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[#4f5e71] text-[14px] text-center tracking-[0.2px]">Any Category</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="filter">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Group">
          <g id="Path" />
          <path d={svgPaths.p27a0b780} id="Path_2" stroke="var(--stroke-0, #4F5E71)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative self-stretch">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex gap-[12px] items-center justify-center px-[16px] py-[12px] relative size-full">
          <Filter />
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.4] not-italic relative shrink-0 text-[#4f5e71] text-[14px] text-center tracking-[0.2px]">Any Type</p>
        </div>
      </div>
    </div>
  );
...
function Frame57() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full">
      ...
      <div className="flex h-0 items-center justify-center relative self-center shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none h-full rotate-90">
          <div className="h-full relative w-[48px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 1">
                <line id="Line 13" stroke="var(--stroke-0, black)" strokeOpacity="0.08" x2="48" y1="0.5" y2="0.5" />
              </svg>
            </div>
          </div>
        </div>
...
function Plus4() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[24px] top-1/2" data-name="Plus">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Plus">
          <path d={svgPaths.p14a3a2f0} fill="var(--fill-0, #252A31)" id="Glyph" />
        </g>
      </svg>
    </div>
  );
...
function Plus3() {
  return (
    <div className="bg-[#e8edf1] relative rounded-br-[6px] rounded-tr-[6px] shrink-0 size-[32px]" data-name="Plus">
      <Plus4 />
    </div>
  );
}
...
function Stepper() {
  return (
    <div className="bg-[#eff2f5] content-stretch flex gap-[4px] items-center overflow-clip pl-[12px] relative rounded-[6px] shrink-0" data-name="Stepper">
      <div className="flex flex-col font-['Inter:Bold',sans-serif] font-bold h-[20px] justify-center leading-[0] not-italic relative shrink-0 text-[#252a31] text-[14px] text-center w-[38px]">
        <p className="leading-[20px] whitespace-pre-wrap">Add</p>
      </div>
      <Plus3 />
    </div>
  );
...
function Frame29() {
  return (
    <div className="bg-[#f5f7f9] relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[12px] py-[8px] relative w-full">
          <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0172cb] text-[14px] tracking-[0.2px] uppercase whitespace-nowrap">
...
function PartsAndServicesStepper() {
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="Parts and Services Stepper">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <Frame27 />
        <Frame29 />
      </div>
...
function PartsAndServicesStepper1() {
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="Parts and Services Stepper">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <Frame30 />
...
function PartsAndServicesStepper2() {
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="Parts and Services Stepper">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <Frame33 />
...
function PartsAndServicesStepper3() {
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="Parts and Services Stepper">
      <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full">
        <Frame36 />
    ...
    <div className="relative shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start p-[16px] relative w-full">
          <PartsAndServicesStepper />
          <PartsAndServicesStepper1 />
          <PartsAndServicesStepper2 />
          <PartsAndServicesStepper3 />
        </div>
      </div>
    </div>
  );

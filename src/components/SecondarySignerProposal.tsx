...
import { CheckCircle2, Pen, FileText, Eraser, Check } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[var(--zuper-background)] pb-24 sm:pb-28">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t-2 border-[var(--zuper-border)] shadow-lg z-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          {savedSignatureData ? (
            /* Signed state - show signature preview and submit button */
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-3 flex-1">
                <Pen className="w-5 h-5 text-[var(--zuper-primary)] flex-shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-[var(--zuper-text-primary)] truncate">
      ...
      <Dialog open={isSignatureDialogOpen} onOpenChange={setIsSignatureDialogOpen}>
        <DialogContent className="sm:max-w-[600px] bg-[var(--zuper-card)] border-[var(--zuper-border)]">
          <DialogHeader>
            <DialogTitle className="text-[var(--zuper-text-primary)]">Add Your Signature</DialogTitle>
            <DialogDescription className="text-[var(--zuper-text-secondary)]">
              Draw your signature below to complete this proposal
            </DialogDescription>
          </DialogHeader>
